...
let greeting:string="Hello World!";             // its a simple greeting message.
...
let sumValue:number=num1+num2;                  // Sum Rule
let differenceValue:number=num1-num2;           // Difference or Minus Rule
let productValue:number=num1*num2;              // Multiplication Rule  
let quotientValue:number=num1/num2;             // Division Rule
...
let age:number = 19;            //output: In this case else message will not print because age is above 18.
...
let fohrenheit:number=98;

let celsius:number=(fohrenheit-32)*5/9      // This formula is taken by searching from Google. 
